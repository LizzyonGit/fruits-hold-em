...
I have been testing throughout developing, fixing issues as I went. I deployed early in the process to be able to continiously test on the deployed version rather than only the local version.
- - -
