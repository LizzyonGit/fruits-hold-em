...
I have been testing throughout development, fixing issues as I went. I deployed early in the process to be able to continuously test on the deployed version rather than only the local version.
- - -
